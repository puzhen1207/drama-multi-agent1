...
<p align="center"><img src="outputs/vue-color-polish-final.png" alt="Drama Multi Agent Web UI" width="820"></p>
...
LLM_BASE_URL=https://api.deepseek.com#自己自行配置
LLM_MODEL=deepseek-flash#自己自行配置
LLM_TEMPERATURE=0.7
LLM_TIMEOUT=120
